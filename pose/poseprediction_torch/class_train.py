...
parser.add_argument('--data', default='/data5/lekevin/plankton/poseprediction/poseprediction_torch/data/4',
...
def main():
    ...
    model = resnet50(pretrained=True,num_classes=num_class)
